...
def train(num_epoch: int = 30, lr: float = 1e-3, batch_size: int = 128, seed: int = 2024):
    ...
    # NOTE: no class weighting here, unlike train_detection.py in homework3 (which used [1, 10, 10])
    ...
    torch.save(model.state_dict(), "detector_noweights.th")
    print("saved detector_noweights.th, best val iou:", best_iou)
